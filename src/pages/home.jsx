    ...
    <div className="" >
          ...
          {Industries.map((data, i) => (
            <div key={i} className="p-4">
              <div className="flex flex-col items-center justify-center h-full p-4 bg-white shadow-md rounded-md">
                <img src={data.img} alt={data.title} className="w-20 h-20 mb-4" />
            ...
            <div key={i} className="px-4 mt-10 mb-10">
              <div className="bg-white p-4 shadow-md rounded-md h-full">
                <div className="flex items-center mb-4">
                  <img src={data.img} alt={data.name} className="w-12 h-12 rounded-full mr-4" />
                  <h3 className="text-lg font-semibold">{data.name}</h3>
                </div>
                <p className={`text-sm text-gray-600 ${expanded[i] ? 'line-clamp-none' : 'line-clamp-3'}`}>{data.contant}</p>
                <button className="text-[#4EB3A4] mt-2" onClick={() => handleReadMore(i)}>
      ...
      <div className=''>
        <div className='w-[90%] mx-auto'>
          ...
          <div data-aos="fade-left" className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8'>
            <img src={project_img1} alt="" className='h-auto w-full' />
            <img src={project_img2} alt="" className='h-auto w-full' />
            <div className='col-span-1 lg:col-span-1 row-span-2 flex flex-col space-y-4'>
              <img src={project_img3} alt="" className='h-52 lg:h-[240px]' />
              <img src={project_img4} alt="" className='h-52 lg:h-[240px]' />
            </div>
          </div>
        </div>
      </div>
      <div className='mt-[40px]'>
        <h2 className='text-[30px] font-semibold text-center mb-10'> News & Articles</h2>
